...
export const STATUS_MESSAGES: Record<string, string> = {
  ...
  too_early:
    "Сегодня день отдыха — минимальный перерыв между тренировками ещё не прошёл. " +
    "Можно сделать факультатив (доп. нагрузку, не больше 2 раз в неделю) — загляни в бота.",
