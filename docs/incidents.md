# История инцидентов и разборов

Известные классы багов и их диагностика. Перенесено из `CLAUDE.md` без
изменения содержания (issue #174) — только заголовки/порядок.
