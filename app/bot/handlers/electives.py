...
порядок выбора) + не более ELECTIVE_MAX_PER_WEEK раз в неделю (issue #94:
было 1, стало 2). Снаряд не выбирается — всегда тот же, что закреплён за
пользователем в блоке на объём на момент выполнения
