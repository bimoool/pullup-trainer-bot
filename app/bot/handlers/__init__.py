...
from app.bot.handlers.electives import router as electives_router
...
from app.bot.handlers.profile_edit import router as profile_edit_router
...
from app.bot.handlers.training_reminder import router as training_reminder_router
...
router.include_router(training_reminder_router)
...
router.include_router(electives_router)
